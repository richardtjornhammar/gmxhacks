...
echo "load newest_energy" > $choice.m
echo "X=newest_energy" >> $choice.m
echo "M=length(X);" >> $choice.m
octave $choice.m > $choice.log

mv newest_energy $choice.dat
