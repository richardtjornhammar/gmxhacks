...
const char *eGUESSWF_names[eGUESSwfNR+1] = {
  "no","yes","small","big", NULL
};
...
const char *gtypes[egcNR+1] = {
  ...
  "User1", "User2", "VCM", "XTC", "Or. Res. Fit", "QMMM", "QMskip",NULL
};
...
const char *eQMfunctional_names[eQMfunctionalNR+1] = {
  "B3LYP","KMLYP","PBE",NULL
};

const char *eQMbasis_names[eQMbasisNR+1] = {
  "STO3G", "STO-3G", "STO-3G*","STO-6G", "STO-6G*",
  "3-21G", "3-21G*", "3-21+G*", "6-21G",
  "6-31G", "6-31G*", "6-31G**",
