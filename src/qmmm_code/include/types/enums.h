/*
 * $Id: enums.h,v 1.70 2008/07/24 14:39:39 hess Exp $
 * 
...
enum {
  ...
  eQMmethodUHF, eQMmethodDFT, eQMmethodB3LYP, 
  eQMmethodMP2, eQMmethodCASSCF, eQMmethodB3LYPLAN,
  eQMmethodDIRECT, eQMmethodCLKS, eQMmethodHSOSKS,
  eQMmethodUKS, eQMmethodCLHF, eQMmethodHSOSHF,
  eQMmethodMBPT2, eQMmethodNR
};

enum {
  eQMfunctionalB3LYP, eQMfunctionalKMLYP, eQMfunctionalPBE, eQMfunctionalNR
};

enum {
  eQMbasisSTO3G, eQMbasisSTO3G2,  eQMbasisSTO3G2p, eQMbasisSTO6G2, eQMbasisSTO6G2d,
  eQMbasis321G, eQMbasis321Gp, eQMbasis321dGp, eQMbasis621G,
  eQMbasis631G, eQMbasis631Gp, eQMbasis631Gpp,
  eQMbasis631dG, eQMbasis631dGp, eQMbasis631dGpp,
  eQMbasis631ddG, eQMbasis631ddGp, eQMbasis631ddGpp,
  eQMbasis6311G, eQMbasis631dG2dp, eQMbasis631ddG2dp,
  eQMbasis631ddG3dp, eQMbasisNR
};
...
enum {
  eMPQC, eGAUSSIAN, eMOPAC, eGAMESS, eQMengineNR
};

enum {
  eGWFno, eGWFyes, eGWFs, eGWFb, eGUESSwfNR
};

enum{
  eIncludeNONE, eIncludeYES, eIncludeQ, eIncludeQQ, eIncludeQQQ, eIncludeNR
};
