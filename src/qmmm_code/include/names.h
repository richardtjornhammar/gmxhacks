/*
 * $Id: names.h,v 1.31 2008/04/11 11:59:54 hess Exp $
 * 
...
extern const char *eQMengine_names[eQMengineNR+1];
extern const char *eQMincludeQ_names[eIncludeNR+1];
extern const char *eGUESSWF_names[eGUESSwfNR+1];
extern const char *eQMfunctional_names[eQMfunctionalNR+1];
...
#define EQMENGINE(e)   ENUM_NAME(e,eQMengineNR,eQMengine_names)
#define EGUESSWF(e)    ENUM_NAME(e,eGUESSwfNR,eGUESSWF_names)
#define EQMINCLUDEQ(e) ENUM_NAME(e,eIncludeNR,eQMincludeQ_names)
#endif	/* _names_h */
